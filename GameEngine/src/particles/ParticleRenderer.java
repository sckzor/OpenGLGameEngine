...
public class ParticleRenderer {
	...
	protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera, boolean useAdditive){
	...
	// use additive for magic like effects
	
	private void prepare(boolean useAdditive){
