...
public class ReflectiveShader extends ShaderProgram{
	
	private static final String VERTEX_FILE = "src/reflectiveEntity/reflectiveVertexShader.txt";
	private static final String FRAGMENT_FILE = "src/reflectiveEntity/reflectiveFragmentShader.txt";
